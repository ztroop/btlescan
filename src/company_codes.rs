...
static COMPANY_CODE: OnceLock<HashMap<u16, &'static str>> = OnceLock::new();

#[allow(clippy::too_many_lines, clippy::large_stack_arrays)]
fn company_code_init() -> HashMap<u16, &'static str> {
    HashMap::from([
        ...
        (0x09BF, "Span.IO, Inc."),
        (0x09BE, "Vessel Ltd."),
        (0x09BD, "Electronique et de Microtechnique SA"),
        (0x09BC, "Aerosens LLC"),
...
pub fn get_company_name(code: u16) -> &'static str {
    COMPANY_CODE
        .get_or_init(company_code_init)
        .get(&code)
        .copied()
        .unwrap_or("n/a")
}
...
mod tests {
    ...
    #[test]
    fn test_get_company_name_known() {
        assert_eq!(get_company_name(0x0000), "Ericsson AB");
        assert_eq!(get_company_name(0x004C), "Apple, Inc.");
        assert_eq!(get_company_name(0x0002), "Intel Corp.");
    }

    #[test]
    fn test_get_company_name_unknown() {
        assert_eq!(get_company_name(0xFFFF), "n/a");
        assert_eq!(get_company_name(0x1234), "n/a");
    }
}
